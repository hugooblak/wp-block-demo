...
/**
 * Title: Page intro
 * Slug: fieldpass/page-intro
 * Categories: fieldpass, banner
 * Keywords: intro, title, header
 * Viewport Width: 1400
 *
 * Simple opening section for inner pages: label, page heading, intro, one button.
 */
?>
...
<!-- wp:group {"style":{"layout":{"selfStretch":"fit"}},"layout":{"type":"constrained","contentSize":"760px","justifyContent":"left"}} -->
<div class="wp-block-group">
<!-- wp:paragraph {"className":"is-eyebrow","style":{"color":{"text":"var:preset|color|primary"}}} -->
<p class="is-eyebrow has-text-color" style="color:var(--wp--preset--color--primary)">Page label</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1} -->
