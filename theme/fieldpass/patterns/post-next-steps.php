<?php
/**
 * Title: After an article: next steps
 * Slug: fieldpass/post-next-steps
 * Categories: fieldpass, call-to-action
 * Keywords: help, demo, next steps
 * Viewport Width: 1400
 *
 * Shown under every blog post. Two neutral options, so families reading a
 * guide and schools reading a tip both have a clear next step.
 */
?>
...
<!-- wp:columns {"className":"is-equal-cards","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|40"}}}} -->
<div class="wp-block-columns is-equal-cards">
<!-- wp:column -->
