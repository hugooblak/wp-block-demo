...
( function ( wp ) {
	...
	function FaqOrderPanel() {
		...
		return el(
			...
			{ name: 'fieldpass-faq-order', title: __( 'Order', 'fieldpass-faq' ), initialOpen: true },
			el( TextControl, {
				label: __( 'Position in the list', 'fieldpass-faq' ),
				help: __( 'Lower numbers show first. Tip: use 10, 20, 30 so you can slot new questions in between.', 'fieldpass-faq' ),
				type: 'number',
				min: 0,
				value: order || 0,
	...
	registerPlugin( 'fieldpass-faq-order', { render: FaqOrderPanel } );
